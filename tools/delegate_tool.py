...
def _build_child_agent(
    ...
    child = AIAgent(
        ...
        temperature=getattr(parent_agent, "worker_temperature", None),
...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "CRITICAL — delegate_task spawns anonymous subagents of YOUR OWN profile, "
        "not named agents. For cross-agent routing, use Kanban: "
        "`hermes kanban create --assignee <agent>`.\n"
        "NEVER use delegate_task to route work to a different named agent.\n\n"

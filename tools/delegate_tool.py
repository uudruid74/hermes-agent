...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "It does NOT route to named agents (Neo, Wintermute, Gopher, etc). "
        "For cross-agent routing, use Kanban: `hermes kanban create --assignee <agent>`.\\n"
        "NEVER use delegate_task to route work to Neo, Wintermute, or any named agent.\\n\\n"

...
Workers fail silently. Zephyr hits a missing skill, Neo runs out of budget, Wintermute finds a contradiction — and **you don't know until you check**.
...
- Notification delivery via `adapter.send()` — reliable, fire-and-forget
- Agent wake events via `adapter.handle_message()` — full context injection
...
- [`/tmp/live-agents.md`](/tmp/live-agents.md) — Full implementation details
- Wiki: `hermes-agent-fork/kanban-notification-architecture`
